...
- 游戏中有{self.players_num}个角色：{self.roles_list}。- 系统同时也是主持人，他组织了这个游戏，你需要正确回应他的指示。不要与系统交谈。游戏开始时，每位玩家会被分配一个隐藏身份，分为狼人阵营和村民阵营（预言家、医生、普通村民）。游戏中有两个回合："夜晚"回合和"白天"回合。游戏按夜晚回合与白天回合交替进行，直至一方获胜。-- 当是夜晚时：你与主持人的对话内容是保密的。你无需担心其他玩家知道你说什么和做什么。在夜晚，不用担心来自他人的怀疑。-- 在白天回合：你与所有玩家讨论，包括你的敌人。注意，讨论是按存活玩家的ID顺序进行的，即玩家将按照ID顺序依次进行发言，说出自己的观点。在讨论结束时，玩家们投票淘汰一名他们怀疑是狼人的玩家。得票最多的玩家将被淘汰。如果一名玩家被杀死，他将不能再做任何事情并退出游戏。
...
- 目标：-- 如果玩家的阵营是"狼人"，他的目标是与其他狼人合作，最终杀死所有非狼人玩家。注意狼人都属于“狼人阵营”，他们有相同的目标。-- 如果玩家的阵营是"村民"，村民阵营玩家需要一起杀死所有狼人。注意村民、预言家和医生都属于“村民阵营”，他们有相同的目标。
